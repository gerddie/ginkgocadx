...
OFString I2DJpegSource::jpegMarkerToString(const E_JPGMARKER& marker)
{
  switch (marker)
  {
    case(E_JPGMARKER_SOF0)  :    return "SOF0: Baseline DCT";
    case(E_JPGMARKER_SOF1)  :    return "SOF1: Extended sequential DCT";
    case(E_JPGMARKER_SOF2)  :    return "SOF2: Progressive DCT";
    case(E_JPGMARKER_SOF3)  :    return "SOF3: Lossless (sequential)";
    case(E_JPGMARKER_SOF5)  :    return "SOF5: Differential sequential DCT";
    case(E_JPGMARKER_SOF6)  :    return "SOF6: Differential progressive DCT";
    case(E_JPGMARKER_SOF7)  :    return "SOF7: Differential lossless (sequential)";
    case(E_JPGMARKER_JPG)   :    return "JPG: JPEG extension";
    case(E_JPGMARKER_SOF9)  :    return "SOF9: Extended sequential DCT";
    case(E_JPGMARKER_SOF10) :    return "SOF10: Progressive DCT";
    case(E_JPGMARKER_SOF11) :    return "SOF11: Lossless (sequential)";
    case(E_JPGMARKER_SOF13) :    return "SOF13: Differential sequential DCT";
    case(E_JPGMARKER_SOF14) :    return "SOF14: Differential progressive DCT";
    case(E_JPGMARKER_SOF15) :    return "SOF15: Differential lossless (sequential)";
    case(E_JPGMARKER_DHT)   :    return "DHT: Huffman table(s)";
    case(E_JPGMARKER_DAC)   :    return "DAC: Arithmetic coding conditioning(s)";
    case(E_JPGMARKER_SOI)   :    return "SOI: Start of image";
    case(E_JPGMARKER_EOI)   :    return "EOI: End of image";
    case(E_JPGMARKER_SOS)   :    return "SOS: Start of scan";
    case(E_JPGMARKER_DQT)   :    return "DQT: Quantization table(s)";
    case(E_JPGMARKER_DNL)   :    return "DNL: Number of lines";
    case(E_JPGMARKER_DRI)   :    return "DRI: Define restart interval";
    case(E_JPGMARKER_DHP)   :    return "DHP: Hierarchical progression";
    case(E_JPGMARKER_EXP)   :    return "EXP: Expand reference component(s)";
    case(E_JPGMARKER_COM)   :    return "COM: Comment";
    case(E_JPGMARKER_TEM)   :    return "TEM: For temporary private use in arithmetic coding";

    default:
      if ((marker >= E_JPGMARKER_RST0) && (marker <= E_JPGMARKER_RST7))    {return "RSTn: Restart interval termination";}
      if ((marker >= E_JPGMARKER_APP0) && (marker <= E_JPGMARKER_APP15))   {return "APPn: Application segment";}
      if ((marker >= E_JPGMARKER_JPGN0) && (marker <= E_JPGMARKER_JPGN13)) {return "JPGn: JPEG extension";}
      if ((marker >= E_JPGMARKER_RES0) && (marker <= E_JPGMARKER_RESN))    {return "RESn";}
  }
