...
class ProxySettingsDialogBase : public wxDialog 
{
	...
	protected:
		...
		// Virtual event handlers, overide them in your derived class
		virtual void OnCheckAuthentication( wxCommandEvent& event ) { event.Skip(); }
...
class ModalityPanelBase : public wxPanel 
{
	...
	protected:
		...
		virtual void OnSetupCornerAnnotations( wxCommandEvent& event ) { event.Skip(); }
...
class SmartRetrieveConfigurationPanelBase : public wxPanel 
{
	...
	protected:
		...
		// Virtual event handlers, overide them in your derived class
		virtual void OnCheckEnableBackgroundQueries( wxCommandEvent& event ) { event.Skip(); }
